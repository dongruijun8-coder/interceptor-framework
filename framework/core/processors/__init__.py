...
from .encryption.aes_ecb import AesEcbEncryption
...
from .signing.md5_sorted_kv import Md5SortedKvSigning
...
ProcessorRegistry.register(AesEcbEncryption)
...
ProcessorRegistry.register(Md5SortedKvSigning)
